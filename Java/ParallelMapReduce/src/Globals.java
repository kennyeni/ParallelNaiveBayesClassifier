...
public class Globals {
	...
	public static CyclicBarrier readLatch;
	public static CountDownLatch reduceLatch;
	public static CountDownLatch mapLatch;
	public static CountDownLatch classifcationLatch;
